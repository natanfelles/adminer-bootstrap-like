 ...
 * @license http://www.gnu.org/licenses/gpl-2.0.html GNU General Public License, version 2 (one or
 *          other)
 */
		...
		<div id="login">
			<table cellspacing="0">
				<tr>
					...
					<td>
						<input type="hidden" name="auth[driver]" value="<?php echo $this->driver; ?>"><select name="auth[server]"><?php echo optionlist($this->servers, SERVER); ?></select>
				<tr>
